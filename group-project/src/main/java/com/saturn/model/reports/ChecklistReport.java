...
public class ChecklistReport {
	...
	public JasperPrint generateReport(List<ChecklistSuperClass> list) {
		...
		String ouptup = directory + File.separatorChar +"Downloads"+File.separatorChar+"ChecklistReport.pdf";
		...
		try {
			...
			jasperPrint = JasperFillManager.fillReport(sourceFile, parameters, new JREmptyDataSource());
